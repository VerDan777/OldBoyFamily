  ...
  <body>
    ...
    <header class="site-header">
      ...
      <div class="socials"><a class="socials__link" href="https://vk.com/oldboyfamily" target="_blank">
          ...
          </svg></a><a class="socials__link socials__link--info" href="<?php echo esc_url(home_url('/info'))?>">
    ...
    <?php
        $args = array(
            ...
            'walker'            => new mywalker_nav_menuWithout,
                  ...
                  <div class="cards__footer">
                    <?php
                      if($post_tags) {
                        foreach($post_tags as $tag) {
                    ?>
                          <a class="cards__badge" href="#"><?php echo $tag->name . '';?></a>
                        <?php
                        }
                      }
                    ?>
