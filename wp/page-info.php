    ...
    <div class="container container--info">
        ...
        <div class="info__questions-container" id="questions">
            ...
            <ul class="info__list">
                ...
                <li class="info__item">DOC - документ в формате Microsoft Word.</li>
            </ul>
            ...
            <ul class="info__list">
                <li class="info__item">Файлы формата DOC открываются программой Microsoft Word(входит в пакет Microsoft Office), <a href="https://products.office.com/ru-ru/office-online/documents-spreadsheets-presentations-office-online">ссылка на официальный сайт</a>.</li>
            </ul>
        ...
        <h2 class="info__title">Сайт состоит из 5 основных шрифтов:</h2>
        <ul class="info__list">
